    ...
    return (
        <div className="places">
            ...
            <div className="row row-cols-1 row-cols-md-4 g-4">
                <div className="col">
                    <div className="card"> 
                        <img src="/images/Sundarban.jpg" class="card-img-top" alt="..." />
                ...
                <div className="col">
                    <div className="card">
                        <img src="/images/Sandakphu.jpg" class="card-img-top" alt="..." />
                        <div className="card-body ">
                ...
                <div className="col">
                    <div className="card">
                        <img src="/images/lepchajagat.jpg" class="card-img-top" alt="..." />
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card">
                        <img src="/images/Mousuni.jpg" class="card-img-top" alt="..." />
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card">
                        <img src="/images/Ahaldara.jpeg" class="card-img-top" alt="..." />
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card">
                        <img src="/images/mawryngkhang.jpg" class="card-img-top" alt="..." />
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card">
                        <img src="/images/todey.jpg" class="card-img-top" alt="..." />
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card">
                        <img src="/images/saryuvalley.jpg" class="card-img-top" alt="..." />
                        <div className="card-body">
